    ...
    <body>
        ...
        <table class="items">
            <tr>
                ...
                <th><? echo Yii::t('VReport', 'CC Result'); ?></th>
            ...
            foreach ($reports as $key => $r) {
                ...
                if ($module != $r->module_id) {
                    echo CHtml::tag('tr');
                    echo CHtml::tag('td', array('colspan' => 8, 'style' => 'font-weight: bold; text-align: left'), CHtml::tag('label', array('for' => 'module_id' . $r->module_id), $r->module_name));
                    $module = $r->module_id;
                }
                ...
                echo CHtml::tag('td', array('style' => 'text-align: center'), $r->getCCResultHtml());
